	...
	<!--Summernote [ OPTIONAL ]-->
	<script src="<?php echo base_url(); ?>template/back/plugins/summernote/summernote.min.js"></script>
    ...
    <script type="text/javascript">
		...
		function sale_check(){
			...
			$.ajax({
				url: '<?php echo base_url(); ?>index.php/admin/sales/total/'+toto,
		...
		function session_check(){
			$.ajax({
				url: '<?php echo base_url(); ?>index.php/admin/is_logged/',
				success: function(data) {
					if(data == 'yah!good'){}
