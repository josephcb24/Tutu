    ...
    ?>
        ...
        <div class="panel-footer">
            <div class="row">
                ...
                <div class="col-md-1">
                    <span class="btn btn-success btn-md btn-labeled fa fa-upload pull-right" onclick="form_submit('slider_serial','<?php echo translate('slider_serial_saved!'); ?>');proceed('to_list');" ><?php echo translate('save');?></span>
                </div>
