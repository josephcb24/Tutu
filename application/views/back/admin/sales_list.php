<div class="panel-body" id="demo_s">
    <table id="demo-table" class="table table-striped"  data-pagination="true" data-show-refresh="true"  data-show-toggle="true" data-show-columns="true" data-search="true" >
        ...
        <tr class="<?php if($row['viewed'] !== 'ok'){ echo 'pending'; } ?>" >
            ...
            <td>
            	<span class="label label-<?php if($row['delivery_status'] == 'delivered'){ ?>purple<?php } else { ?>danger<?php } ?>">
					<?php echo ucfirst($row['delivery_status']); ?>
                </span>
            </td>
            <td>
                <span class="label label-<?php if($row['payment_status'] == 'paid'){ ?>success<?php } else { ?>danger<?php } ?>">
    ...
    <div id='export-div' style="padding:40px;">
		...
		<table id="export-table" class="table" data-name='sales' data-orientation='l' data-width='1500' style="display:none;">
				...
				<tr>
                    ...
                    <td><?php echo ucfirst($row['delivery_status']); ?></td>
