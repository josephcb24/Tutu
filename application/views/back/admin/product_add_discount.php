	...
	?>
        <div class="panel-body">
            ...
            <div class="form-group btm_border">
                ...
                <div class="col-sm-4">
                    <input type="number" name="discount" id="demo-hor-1" min='0' value="<?php echo $this->crud_model->get_type_name_by_id('product',$product,'discount'); ?>" placeholder="Product Discount" class="form-control">
                </div>
                <div class="col-sm-2">
